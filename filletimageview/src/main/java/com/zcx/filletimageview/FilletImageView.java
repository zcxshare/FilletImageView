...
public class FilletImageView extends ImageView {
    ...
    public FilletImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.FilletImageView_fiv_border_width, DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(R.styleable.FilletImageView_fiv_border_color, DEFAULT_BORDER_COLOR);
        mBorderOverlay = a.getBoolean(R.styleable.FilletImageView_fiv_border_overlay, DEFAULT_BORDER_OVERLAY);
        mRadius = a.getDimensionPixelSize(R.styleable.FilletImageView_fiv_radius, DEFAULT_RADIUS);

        // Look for deprecated civ_fill_color if civ_circle_background_color is not set
        if (a.hasValue(R.styleable.FilletImageView_fiv_circle_background_color)) {
            mCircleBackgroundColor = a.getColor(R.styleable.FilletImageView_fiv_circle_background_color,
                    DEFAULT_CIRCLE_BACKGROUND_COLOR);
        } else if (a.hasValue(R.styleable.FilletImageView_fiv_fill_color)) {
            mCircleBackgroundColor = a.getColor(R.styleable.FilletImageView_fiv_fill_color,
                    DEFAULT_CIRCLE_BACKGROUND_COLOR);
        }
...
//                canvas.drawCircle(mBorderRect.centerX(), mBorderRect.centerY(), mBorderRadius, mBorderPaint);
    ...
    private void setup() {
        ...
        if (isFillet()) {
            mBorderRadius = mRadius - mBorderWidth / 2.0f;
